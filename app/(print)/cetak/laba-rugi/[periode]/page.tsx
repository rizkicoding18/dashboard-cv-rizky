...
import { LabaRugiDocument } from "@/components/finance-reports";
...
export default async function CetakLabaRugiPage({
  params,
}: {
  ...
  return (
    <div className="min-h-full bg-stone-100 py-6 print:bg-white print:py-0">
      <PrintToolbar
        ...
        printLabel="Cetak laba rugi"
        pdfLabel="Unduh PDF"
      />
      <LabaRugiDocument profile={db.profile} finance={finance} />
    </div>
  );
}
